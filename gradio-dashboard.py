...
doucuments = text_splitter.split_documents(raw_documents)
db_books = Chroma.from_documents(doucuments, embedding=embedding)
...
def recommend_books(
    ...
    recommendations = retrieve_semantic_recommandations(query, category, tone)
    results = []
